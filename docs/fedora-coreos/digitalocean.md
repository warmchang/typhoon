...
In this tutorial, we'll create a Kubernetes v1.36.2 cluster on DigitalOcean with Fedora CoreOS.
...
```tf
module "nemo" {
  source = "git::https://github.com/poseidon/typhoon//digital-ocean/fedora-coreos/kubernetes?ref=v1.36.2"
