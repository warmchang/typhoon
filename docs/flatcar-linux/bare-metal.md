...
In this tutorial, we'll network boot and provision a Kubernetes v1.36.2 cluster on bare-metal with Flatcar Linux.
...
```tf
module "mercury" {
  source = "git::https://github.com/poseidon/typhoon//bare-metal/flatcar-linux/kubernetes?ref=v1.36.2"
...
module "mercury-node1" {
  source = "git::https://github.com/poseidon/typhoon//bare-metal/fedora-coreos/kubernetes/worker?ref=v1.36.2"
...
node1.example.com   Ready   <none>  10m  v1.36.2
node2.example.com   Ready   <none>  10m  v1.36.2
node3.example.com   Ready   <none>  10m  v1.36.2
```
