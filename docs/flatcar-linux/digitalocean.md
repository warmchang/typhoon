...
In this tutorial, we'll create a Kubernetes v1.36.2 cluster on DigitalOcean with Flatcar Linux.
...
```tf
module "nemo" {
  source = "git::https://github.com/poseidon/typhoon//digital-ocean/flatcar-linux/kubernetes?ref=v1.36.2"
...
10.132.110.130     Ready   <none>  10m  v1.36.2
10.132.115.81      Ready   <none>  10m  v1.36.2
10.132.124.107     Ready   <none>  10m  v1.36.2
```
